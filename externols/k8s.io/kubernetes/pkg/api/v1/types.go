...
import (
	...
	"gwproxy/externols/k8s.io/kubernetes/pkg/types"
...
type ContainerPort struct {
	...
	// +optional
	HostPort int `json:"hostPort,omitempty" protobuf:"varint,2,opt,name=hostPort"`
...
type HTTPGetAction struct {
	...
	Port util.IntOrString `json:"port" protobuf:"bytes,2,opt,name=port"`
...
type TCPSocketAction struct {
	...
	// Number must be in the range 1 to 65535.
	// Name must be an IANA_SVC_NAME.
	Port util.IntOrString `json:"port" protobuf:"bytes,1,opt,name=port"`
}
...
type ReplicationControllerStatus struct {
	...
	// +optional
	FullyLabeledReplicas int `json:"fullyLabeledReplicas,omitempty" protobuf:"varint,2,opt,name=fullyLabeledReplicas"`

	// The number of ready replicas for this replication controller.
	// +optional
	ReadyReplicas int `json:"readyReplicas,omitempty" protobuf:"varint,4,opt,name=readyReplicas"`

	// The number of available replicas (ready for at least minReadySeconds) for this replication controller.
	// +optional
	AvailableReplicas int `json:"availableReplicas,omitempty" protobuf:"varint,5,opt,name=availableReplicas"`
...
type ServicePort struct {
	...
	Port int `json:"port" protobuf:"varint,3,opt,name=port"`
	...
	// +optional
	TargetPort util.IntOrString `json:"targetPort,omitempty" protobuf:"bytes,4,opt,name=targetPort"`
	...
	// +optional
	NodePort int `json:"nodePort,omitempty" protobuf:"varint,5,opt,name=nodePort"`
}
...
type DaemonEndpoint struct {
	...
	*/
	...
	Port int `json:"Port" protobuf:"varint,1,opt,name=Port"`
}
...
type PodPortForwardOptions struct {
	...
	// +optional
	Ports []int `json:"ports,omitempty" protobuf:"varint,1,rep,name=ports"`
}
